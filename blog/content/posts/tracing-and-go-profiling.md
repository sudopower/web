...
![OTEL Trace in Tempo and Grafana](images/OTEL%20tempo%20trace.png)
...
![Flame Graph from pprof](images/flame%20graph.png)
...
![CPU Flow from pprof](images/sink%20cpu%20flow.jpg)
